...
public class Sistema {
	public static void main(String [] args) {
		...
		for(int i = 0; i < qtd ; i++) {
			...
			System.out.println("Digite a nota 1 do aluno " + alunos[i]);
			notas[i][0] = leitor.nextDouble();
			leitor.reset();
			
			System.out.println("Digite a nota 2 do aluno " + alunos[i]);
		...
		System.out.println("A maior nota é do aluno: " + alunos[indexMaior] + " Nota: " + notas[indexMaior][2]); 
		System.out.println("A menor nota é do aluno: " + alunos[indexMenor] + " Nota: " + notas[indexMenor][2]); 
		leitor.close();
